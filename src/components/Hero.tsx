...
const Hero: React.FC = () => {
  ...
  const statsData = [
    { icon: Target, value: `${currentStats.projects}+`, label: 'Successful Projects' },
    { icon: Users, value: `${currentStats.collaborations}+`, label: 'Industry Collaborations' },
    { icon: Award, value: `${currentStats.satisfaction}%`, label: 'Customer Satisfaction' },
    { icon: Calendar, value: `${currentStats.experience}+`, label: 'Years of Experience' }
  ];
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-poppins font-bold text-white mb-6 leading-tight">
              ...
              <br />
              <motion.span
                className="inline-block bg-gradient-to-r from-secondary-500 to-secondary-400 bg-clip-text text-transparent"
          ...
          {/* Sub-headline */}
          <motion.p
            className="text-xl md:text-2xl text-white/90 font-inter max-w-4xl mx-auto mb-12 leading-relaxed"
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 1, delay: 0.8 }}
          >
            With over 20 years of experience in core transformer manufacturing, we deliver innovative energy solutions from Istanbul to the world.
          </motion.p>
          ...
          >
            <motion.button
              className="bg-gradient-to-r from-secondary-600 to-secondary-500 text-white px-8 py-4 rounded-lg font-inter font-semibold text-lg flex items-center justify-center gap-3 hover:shadow-2xl transition-all duration-300 group animate-pulse-glow"
            ...
            <motion.button
              className="border-2 border-white text-white px-8 py-4 rounded-lg font-inter font-semibold text-lg hover:bg-white hover:text-primary-700 transition-all duration-300 backdrop-blur-sm bg-white/10"
              whileHover={{ scale: 1.05, y: -2 }}
              whileTap={{ scale: 0.95 }}
            >
              GET A FREE QUOTE
